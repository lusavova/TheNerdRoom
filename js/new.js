    ...
    let currentAuthorInfo = function () {
        ...
        $('.book-author').on('click', function () {
            ...
            //$(".current-author-container ").toggle("slide");
        });
    }
    ...
    let currentBookInfo = function () {
        ...
        $('.book-title').on('click', function () {
            ...
            $(".current-book-container").toggle("slide");
    ...
    // let isFontYellow = false;

    // let changeFontColor = function(){
    //     if(isFontYellow === false){
